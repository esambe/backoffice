...
import Logo from "../../../../assets/img/logos/mon_taxi_logo.png";
import LogoDark from "../../../../assets/img/logos/mon_taxi_logo.png";
               ...
               <div className="sidebar-header">
                  <div className="logo clearfix">
                     <NavLink to="/" className="logo-text float-left">
                        <div className="logo-img">
                           {templateConfig.sidebar.backgroundColor === "white" ? (
                              this.props.sidebarBgColor === "" || this.props.sidebarBgColor === "white" ? (
                                 <img src={LogoDark} alt="logo" width={48} height={"auto"}/>
                              ) : (
                        ...
                        <span className="text align-middle">{"  "}MONTAXI</span>
                     </NavLink>
